...
LOCATION 'wasb://data@week03tweets.blob.core.windows.net/input/tweets/fifa/';
...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION 'wasb://data@week03tweets.blob.core.windows.net/output/tweets/fifa/tsvexport/';
...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION 'wasb://data@week03tweets.blob.core.windows.net/output/tweets/fifa/top20/';
