...
ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t' STORED AS TEXTFILE LOCATION 's3://uwclddata2017/input/twitter/fifa/tweets.txt';
...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION 's3://uwclddata2017/output/twitter/fifa/tsvexport/';
...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION 's3://uwclddata2017/output/twitter/fifa/top20/';
